...
# QtWebEngine. * `{qt_version}`: The underlying Qt version. *
# `{upstream_browser_key}`: "Version" for QtWebKit, "Chrome" for
# QtWebEngine. * `{upstream_broser_version}`: The corresponding
# Safari/Chrome version. * `{qutebrowser_version}`: The currently
# running qutebrowser version.  The default value is equal to the
# unchanged user agent of QtWebKit/QtWebEngine.  Note that the value
# read from JavaScript is always the global value. With QtWebEngine
...
#   - false
#   - ask
config.set('content.notifications.enabled', True, 'https://www.github.com')
...
config.bind('M', 'hint links spawn alacritty -e youtube-dl -x --audio-format mp3 {hint-url}')
config.bind('t', 'set-cmd-text -s :open -t')
config.bind('xb', 'config-cycle statusbar.show always never')
config.bind('xt', 'config-cycle tabs.show always never')
config.bind('xx', 'config-cycle statusbar.show always never;; config-cycle tabs.show always never')
config.bind(',no', 'config-cycle content.user_stylesheets ~/.config/qutebrowser/nord.css')
nord = {
    # Polar Night
    'nord0': '#2e3440',
    'nord1': '#3b4252',
...
## Type: QtColor
c.colors.completion.category.fg = nord['nord13']
...
## Type: QtColor
c.colors.completion.fg = [nord['nord10'], nord['nord4'], nord['nord7']]
...
## Type: QtColor
c.colors.tabs.even.fg = nord['nord3']
...
## Type: QtColor
c.colors.tabs.odd.fg = nord['nord3']
...
# ## Type: QtColor
c.colors.tabs.selected.even.fg = nord['nord6']
...
# ## Type: QtColor
c.colors.tabs.selected.odd.fg = nord['nord6']
